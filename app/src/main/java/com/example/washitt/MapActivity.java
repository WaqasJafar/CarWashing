...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Places.initialize ( MapActivity.this,"AIzaSyDrm53YwapazMKGRMo3EqwQpDcPreKJ6Bk" );
                ...
                placesClient.findAutocompletePredictions ( predictionsRequest ).addOnCompleteListener ( new OnCompleteListener<FindAutocompletePredictionsResponse> () {
                    ...
                    public void onComplete(@NonNull Task<FindAutocompletePredictionsResponse> task) {
                        if (task.isSuccessful ()){
                            ...
                            Log.i("mytag","predication fetching task unsuccessful");
        ...
        materialSearchBar.setSuggestionsClickListener ( new SuggestionsAdapter.OnItemViewClickListener () {
            ...
            public void OnItemClickListener(int position, View v) {
                ...
                final String placeId =selectedPredication.getPlaceId ();
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        //check if gps is enable or not and then requested user to enable it
